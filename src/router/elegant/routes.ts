    ...
    children: [
      {
        ...
        children: [
          {
            matchedFiles: [null, '/src/pages/(base)/blog/index.tsx', null, null],
            name: '(base)_blog',
            path: '/blog',
            handle: { i18nKey: 'route.(base)_blog', title: '(base)_blog' },
            children: [
              {
                matchedFiles: [null, '/src/pages/(base)/blog/article-category/index.tsx', null, null],
                name: '(base)_blog_article-category',
                path: '/blog/article-category',
                handle: { i18nKey: 'route.(base)_blog_article-category', title: '(base)_blog_article-category' }
              },
              {
                matchedFiles: [null, '/src/pages/(base)/blog/article-list/index.tsx', null, null],
                name: '(base)_blog_article-list',
                path: '/blog/article-list',
                handle: { i18nKey: 'route.(base)_blog_article-list', title: '(base)_blog_article-list' }
              },
              {
                matchedFiles: [null, '/src/pages/(base)/blog/blog-author/index.tsx', null, null],
                name: '(base)_blog_blog-author',
                path: '/blog/blog-author',
                handle: { i18nKey: 'route.(base)_blog_blog-author', title: '(base)_blog_blog-author' },
                children: [
                  {
                    matchedFiles: [null, '/src/pages/(base)/blog/blog-author/author-info/index.tsx', null, null],
                    name: '(base)_blog_blog-author_author-info',
                    path: '/blog/blog-author/author-info',
                    handle: {
                      i18nKey: 'route.(base)_blog_blog-author_author-info',
                      title: '(base)_blog_blog-author_author-info'
                    }
                  },
                  {
                    matchedFiles: [null, '/src/pages/(base)/blog/blog-author/job-experience/index.tsx', null, null],
                    name: '(base)_blog_blog-author_job-experience',
                    path: '/blog/blog-author/job-experience',
                    handle: {
                      i18nKey: 'route.(base)_blog_blog-author_job-experience',
                      title: '(base)_blog_blog-author_job-experience'
                    }
                  }
                ]
              }
          ...
          },
          {
            ...
            name: '(base)_home',
            path: '/home',
            handle: { i18nKey: 'route.(base)_home', title: '(base)_home' }
          },
          {
            ...
            children: [
              {
                matchedFiles: [null, '/src/pages/(base)/manage/about/index.tsx', null, null],
                name: '(base)_manage_about',
                path: '/manage/about',
                handle: { i18nKey: 'route.(base)_manage_about', title: '(base)_manage_about' }
              },
              {
