const route: App.I18n.Schema['translation']['route'] = {
  '(base)_blog': '博客管理',
  '(base)_blog_article-category': '文章分类',
  '(base)_blog_article-list': '文章列表',
  '(base)_blog_blog-author': '博客作者',
  '(base)_blog_blog-author_author-info': '作者信息',
  '(base)_blog_blog-author_job-experience': '工作经历',
  '(base)_function': '系统功能',
  ...
  document_api: '接口文档',
  document_procomponents: 'ProComponents文档',
